...
const componentName = "scpdt:mp5k";
const componentNameEmpty = "scpdt:mp5k_empty";
const itemType = "lc:dt_mp5k";
const emptyItemType = "lc:dt_mp5k_empty";
const magItemType = "lc:dt_mp5_mag";
const emptyMagItemType = "lc:dt_mp5_mag_empty";
const bulletTypeNormal = "lc:dt_mp5k_bullet_player";
const bulletTypeSneak = "lc:dt_mp5k_bullet_player_sneak";
const shootingSound = "scpdt.hk_mp5.shot";
const reloadingCooldownCategory = "dt_mp5k_reloading";
const reloadingSound = "scpdt.mp5k.reload";
...
mc.system.beforeEvents.startup.subscribe((e) => {
	...
	e.itemComponentRegistry.registerCustomComponent(componentNameEmpty, {
		onUse({ source, itemStack }) {
			...
			source.startItemCooldown(reloadingCooldownCategory, 4.5 * mc.TicksPerSecond);
