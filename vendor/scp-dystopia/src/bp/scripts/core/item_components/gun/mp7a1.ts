...
const componentName = "scpdt:mp7a1";
const componentNameEmpty = "scpdt:mp7a1_empty";
const itemType = "lc:dt_mp7a1";
const emptyItemType = "lc:dt_mp7a1_empty";
const magItemType = "lc:dt_mp7a1_mag";
const emptyMagItemType = "lc:dt_mp7a1_mag_empty";
const bulletTypeNormal = "lc:dt_mp7a1_bullet_player";
const bulletTypeSneak = "lc:dt_mp7a1_bullet_player_sneak";
const shootingSound = "scpdt.hk_mp5.shot";
const reloadingCooldownCategory = "dt_mp7a1_reload";
const reloadingSound = "scpdt.mp7a1.reload";
