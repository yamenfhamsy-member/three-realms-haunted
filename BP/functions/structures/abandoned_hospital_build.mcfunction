...
loot insert ~-6 ~2 ~-14 slot.container 2 loot "loot_tables/chests/uncommon_rewards"
...
loot insert ~-6 ~-1 ~13 slot.container 2 loot "loot_tables/chests/uncommon_rewards"
